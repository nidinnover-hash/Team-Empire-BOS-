...
def upgrade() -> None:
    ...
    if "autonomy_policy_configs" not in tables:
        op.create_table(
            ...
            sa.Column("allow_auto_approval", sa.Boolean(), nullable=False, server_default=sa.text("true")),
            ...
            sa.Column("block_on_unread_high_alerts", sa.Boolean(), nullable=False, server_default=sa.text("true")),
            sa.Column("block_on_stale_integrations", sa.Boolean(), nullable=False, server_default=sa.text("true")),
            sa.Column("block_on_sla_breaches", sa.Boolean(), nullable=False, server_default=sa.text("true")),
    ...
    if "autonomy_policy_versions" not in tables:
        op.create_table(
