...
def upgrade() -> None:
    ...
    if "organization_memberships" not in tables:
        ...
        existing_indexes = {i["name"] for i in inspector.get_indexes("organization_memberships")}
        if "ix_organization_memberships_organization_id" not in existing_indexes:
            op.create_index(
                "ix_organization_memberships_organization_id",
                "organization_memberships",
                ["organization_id"],
        ...
        if "ix_organization_memberships_user_id" not in existing_indexes:
            op.create_index(
                "ix_organization_memberships_user_id",
                "organization_memberships",
                ["user_id"],
    ...
    if "organization_role_permissions" not in tables:
        op.create_table(
        ...
        existing_indexes = {i["name"] for i in inspector.get_indexes("organization_role_permissions")}
        if "ix_organization_role_permissions_organization_id" not in existing_indexes:
            op.create_index(
                "ix_organization_role_permissions_organization_id",
                "organization_role_permissions",
                ["organization_id"],
        ...
        if "ix_organization_role_permissions_permission" not in existing_indexes:
            op.create_index(
                "ix_organization_role_permissions_permission",
                "organization_role_permissions",
                ["permission"],
        ...
        if "ix_organization_role_permissions_role" not in existing_indexes:
            op.create_index(
                "ix_organization_role_permissions_role",
                "organization_role_permissions",
                ["role"],
