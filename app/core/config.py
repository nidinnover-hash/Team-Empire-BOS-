...
class Settings(BaseSettings):
    ...
    FEATURE_WORKFLOW_V2: bool = True
    FEATURE_WORKFLOW_RUNS: bool = True
    FEATURE_WORKFLOW_APPROVAL_PIPELINE: bool = True
    FEATURE_WORKFLOW_BUILDER_SSR: bool = True
    FEATURE_WORKFLOW_OBSERVABILITY: bool = True
    FEATURE_WORKFLOW_RELIABILITY: bool = True
    FEATURE_WORKFLOW_COPILOT: bool = True
    FEATURE_WORKFLOW_TEMPLATES: bool = True
    FEATURE_WORKFLOW_EXEC_INSIGHTS: bool = True
    FEATURE_WORKFLOW_MEMORY_CONTEXT: bool = True
    FEATURE_QUOTES: bool = False
    FEATURE_PLAYBOOKS: bool = False
    FEATURE_SURVEYS: bool = False
