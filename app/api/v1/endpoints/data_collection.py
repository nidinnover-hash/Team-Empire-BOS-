...
async def mobile_capture_upload_analyze(
    ...
    source: str = Form("mobile_capture_upload", max_length=100),
    device_type: str = Form("mobile", max_length=50),
    capture_type: str = Form("screenshot", max_length=50),
    wanted_topics: str = Form("", max_length=500),
    unwanted_topics: str = Form("", max_length=500),
